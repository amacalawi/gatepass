...
<html>
    <head>
        ...
        <link href="assets/private/css/item.css" rel="stylesheet" type="text/css">
    ...
    <body class="fixed-left">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Desc</label>
                                                <div>
                                                    <input id="description" name="description" type="text" class="form-control" placeholder="Type Something" autocomplete="off"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label>QTY</label>
                                                <div>
                                                    <input id="qty" name="qty" type="number" class="form-control" placeholder="0.00" autocomplete="off"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label>UOM</label>
                                                <div>
                                                    <select id="unit-of-measurement" name="unit-of-measurement" class="form-control">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
		...
		<script src="assets/private/js/item.js" type="text/javascript"></script>
    </body>
</html>
...
<html>
    <head>
        ...
        <link href="assets/private/css/item-source-disposition.css" rel="stylesheet" type="text/css">
    ...
    <body class="fixed-left">
                ...
                <div class="content">
                    <div class="">
                        <div class="page-header-title">
                            <h4 class="page-title">Item [Source]</h4>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <select id="item-source" multiple="" name="unit-of-measurement" class="form-control">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <select id="disposition" name="unit-of-measurement" class="form-control">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
		...
		<script src="assets/private/js/item-source-disposition.js" type="text/javascript"></script>
    </body>
</html>
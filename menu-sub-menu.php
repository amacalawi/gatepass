...
<html>
    <head>
        ...
        <link href="assets/private/css/menu-sub-menu.css" rel="stylesheet" type="text/css">
    ...
    <body class="fixed-left">
                ...
                <div class="content">
                    <div class="">
                        <div class="page-header-title">
                            <h4 class="page-title">Menu [Sub Menu]</h4>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Menu</label>
                                                <div>
                                                    <select id="menu" multiple="" name="unit-of-measurement" class="form-control">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <select id="sub-menu" name="unit-of-measurement" class="form-control">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
		...
		<script src="assets/private/js/menu-sub-menu.js" type="text/javascript"></script>
    </body>
</html>
...
<html>
    <head>
        ...
        <link href="assets/private/css/unit-of-measurement.css" rel="stylesheet" type="text/css">
    ...
    <body class="fixed-left">
                            ...
                            <div class="m-t-20">
                                <form id="form-maintenance" action="#" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label>Code</label>
                                        <div>
                                            <input id="code" name="code" type="text" class="form-control" required data-parsley-minlength="2" placeholder="Min 2 chars." autocomplete="off" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Name</label>
		...
		<script src="assets/private/js/unit-of-measurement.js" type="text/javascript"></script>
    </body>
</html>
...
<html>
    <head>
        ...
        <link href="assets/private/css/user-access.css" rel="stylesheet" type="text/css">
    ...
    <body class="fixed-left">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label>User</label>
                                                <div>
                                                    <select id="username" name="unit-of-measurement" class="form-control">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <select id="menu-sub-menu" multiple="" name="unit-of-measurement" class="form-control">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
		...
		<script src="assets/private/js/user-access.js" type="text/javascript"></script>
    </body>
</html>
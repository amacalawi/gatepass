...
<html>
    <head>
        ...
        <link href="assets/private/css/non-company-items.css" rel="stylesheet" type="text/css">
    ...
    <body class="fixed-left">
                ...
                <div class="content">
                    <div class="">
                        <div class="page-header-title">
                            <h4 class="page-title">Non Company Items</h4>
                        </div>
                    </div>
        ...
        <!-- modal content -->
        <div id="maintenance-width-modal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="maintenance-width-modalLabel" aria-hidden="true">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Name</label>
                                                <div>
                                                    <input id="name" name="name" type="text" class="form-control" required placeholder="Type Something.." autocomplete="off" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Pur No</label>
                                                <div>
                                                    <input id="purchase_no" name="purchase_no" type="text" class="form-control" placeholder="Type Something.." autocomplete="off" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Item</label>
                                                <div>
                                                    <input id="item" name="item" type="text" class="form-control" placeholder="Type Something.." autocomplete="off" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Brand</label>
                                                <div>
                                                    <input id="brand" name="brand" type="text" class="form-control" placeholder="Type Something.." autocomplete="off" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input id="serial_no" name="serial_no" type="text" class="form-control" placeholder="Type Something.." autocomplete="off" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label>Qty</label>
                                                <div>
                                                    <input id="qty" name="qty" type="number" required class="form-control" placeholder="0.00" autocomplete="off" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label>UOM</label>
                                                <div>
                                                    <select id="unit-of-measurement" required name="unit-of-measurement" class="form-control">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <select id="item-source" required name="item-source" class="form-control">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <select id="disposition" required name="disposition" class="form-control">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Remarks</label>
                                                <div>
                                                    <textarea id="remarks" class="form-control" required placeholder="Type Something.."> </textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
		...
		<script src="assets/private/js/non-company-items.js" type="text/javascript"></script>
    </body>
</html>
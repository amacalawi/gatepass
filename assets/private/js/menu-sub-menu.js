...
!function($) {
    ...
    DataTable.prototype.init = function() {
        ...
        /*********** 5 selects *************/
        select_menu('xx');
        function select_menu (code) {
            method = 'list-select';
            $.ajax({
                url : window.location.origin +'/gatepass/assets/private/php/menu.php',
                method: 'post',
                data : {
                    method : method,
                    code : code,
        ...
        select_sub_menu('xx');
        function select_sub_menu (code) {
            method = 'list-select';
            $.ajax({
                url : window.location.origin +'/gatepass/assets/private/php/sub-menu.php',
                method: 'post',
                data : {
                    method : method,
                    code : code,

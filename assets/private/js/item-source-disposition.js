...
!function($) {
    ...
    DataTable.prototype.init = function() {
        ...
        var $datatable;
        var method;
        var id, item_source, disposition;
        var html;
        $datatable = $('#datatable');
        ...
        $('body').on('click', '#btn-restore', function () {
            ...
            method = 'restore';
            $.ajax({
                url : window.location.origin +'/gatepass/assets/private/php/item-source-disposition.php',
                method: 'post',
                data : {
                    method : method,
                    id : id,
        ...
        $('body').on('click', '#btn-save', function () {
            $("#item-source option:selected").each(function () {
               var $this = $(this);
               if ($this.length) {
                    item_source = $this.text();

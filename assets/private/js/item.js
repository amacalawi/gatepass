...
!function($) {
    ...
    DataTable.prototype.init = function() {
        ...
        var $datatable;
        var method;
        var id, code, name, description, qty, unit_of_measurement;
        var html;
        $datatable = $('#datatable');
        ...
        /*********** 5 selects *************/
        select_unit_of_measurement('xx');
        function select_unit_of_measurement (code) {
            method = 'list-select';
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#unit-of-measurement').append(html);
                }
            });
        }
        ...
        $('body').on('click', '#btn-restore', function () {
            ...
            method = 'restore';
            $.ajax({
                url : window.location.origin +'/gatepass/assets/private/php/item.php',
                method: 'post',
                data : {
                    method : method,
                    id : id,
            ...
            $.ajax({
                ...
                success: function (data) {
                    $(data).each(function (index, td) {
                        ...
                        $('#qty').val(td.qty);
                        select_unit_of_measurement(td.unit_of_measurement);
        ...
        $('body').on('click', '#btn-save', function () {
            ...
            qty = $('#qty').val();
            unit_of_measurement = $('#unit-of-measurement').val();

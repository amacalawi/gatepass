...
<html>
    <head>
        ...
        <link href="assets/private/css/disposition.css" rel="stylesheet" type="text/css">
    ...
    <body class="fixed-left">
                ...
                <div class="content">
                    <div class="">
                        <div class="page-header-title">
                            <h4 class="page-title">Disposition</h4>
                        </div>
                    </div>
		...
		<script src="assets/private/js/disposition.js" type="text/javascript"></script>
    </body>
</html>